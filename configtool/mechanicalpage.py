...
class MechanicalPage(wx.Panel, Page):
  def __init__(self, parent, nb, idPg, font):
    ...
    self.homingKeys = [('HOMING_STEP1', 2), ('HOMING_STEP2', 2), ('HOMING_STEP3', 2), ('HOMING_STEP4', 2)]
    ...
    self.labels = {'STEPS_PER_M_X': "X:", 'STEPS_PER_M_Y': "Y:",
                   ...
                   'HOMING_STEP1': "Step 1:", 'HOMING_STEP2': "Step 2:", 'HOMING_STEP3': "Step 3:", 'HOMING_STEP4': "Step 4:",
                   'none': '- ', 'x_negative': 'X min', 'x_positive': 'X max', 'y_negative': 'Y min',
                   'y_positive': 'Y max', 'z_negative': 'Z min', 'z_positive': 'Z max'}

    labelWidth = 40;
    labelWidth_homing = 60;
    ...
    for k, ctype in self.homingKeys:
      if ctype == 2:
        tc = self.addChoice(k, [], 0, labelWidth_homing, self.onChoice)
        sbox.Add(tc)
      sbox.AddSpacer((5, 5))
    sz.Add(sbox, pos = (3, 3))
