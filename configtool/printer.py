...
from configtool.data import (defineValueFormat, defineBoolFormat,
                             ...
                             reHomingOpts, reStartHoming, reEndHoming, reDefHoming, reHoming4)
  ...
  def saveConfigFile(self, path, values):
    ...
    for ln in self.cfgBuffer:
      ...
      if m:
        fp.write(ln)
        fp.write("//\n")
        sstr = "%s, %s, %s, %s" % ((values['HOMING_STEP1'][0]), (values['HOMING_STEP2'][0]), (values['HOMING_STEP3'][0]), (values['HOMING_STEP4'][0]))
